...
/**
 * Clase base abstracta que implementa las operaciones definidas en
 * {@link RoleActions}.
 * <p>
 * Esta clase provee implementaciones comunes para la creación, actualización,
 * obtención y validación de usuarios, tokens y autorizaciones a través del
 * cliente HTTP {@link RedPayClient}.
 * </p>
 */
public abstract class RedPayBase implements RoleActions {

    /**
     * Objeto {@link ObjectMapper} utilizado para la conversión entre objetos
     * Java y Mapas, y para la serialización/deserialización de JSON.
     */
    ...
    /**
     * Constructor por defecto que inicializa el cliente con una instancia por
     * defecto de {@link RedPayClient}.
     */
    public RedPayBase() {
        this(null);
    }
    ...
    /**
     * Constructor que permite especificar una instancia de
     * {@link RedPayClient}.
     *
     * @param client Instancia de {@link RedPayClient} a utilizar. Si es nulo,
     ...
     *
     * @param userInstance Instancia de {@code UserBase} que representa al
     * usuario a crear.
     * @param <T> Tipo que extiende de {@code UserBase}.
     * @return Una respuesta de tipo {@link GenerateUserResponse} que contiene
     * los detalles del usuario creado.
    ...
    /**
     * Actualiza un usuario existente en el sistema a partir de la instancia
     * proporcionada.
     *
     * @param userInstance Instancia de {@code UserBase} con la información
     * actualizada del usuario.
     * @param <T> Tipo que extiende de {@code UserBase}.
     * @return Una respuesta de tipo {@link GenerateUserResponse} con los
     ...
     * <p>
     * Combina la información actual del usuario con los nuevos datos
     * proporcionados, actualizando únicamente los campos no nulos del nuevo
     * objeto.
     * </p>
     *
     * @param userInstance Instancia de {@code UserBase} con los datos parciales
     * a actualizar.
     * @param <T> Tipo que extiende de {@code UserBase}.
     * @return Una respuesta de tipo {@link GenerateUserResponse} con los
    ...
    /**
     * Obtiene la información de un usuario a partir de la instancia
     * proporcionada.
     *
     * @param userInstance Instancia de {@code UserBase} que identifica al
     * usuario a obtener.
     * @param <T> Tipo que extiende de {@code UserBase}.
     * @return Una respuesta de tipo {@link GenerateUserResponse} con los
    ...
    /**
     * Obtiene la información de un usuario o lanza una excepción si el usuario
     * no existe.
     *
     * @param userInstance Instancia de {@code UserBase} que identifica al
     * usuario.
     ...
     * @return Una respuesta de tipo {@link GenerateUserResponse} con los
     * detalles del usuario.
     * @throws Exception Si ocurre algún error durante la operación o si el
    ...
    public <T extends UserBase> GenerateUserResponse getUserOrFail(T userInstance) throws Exception {
        ...
        String jsonResponse = client.getOrFail(PathUrl.UserVerify.getPath(), params);
     ...
     *
     * @param validateTokenRequest Objeto de solicitud que contiene el token a
     * validar.
     * @return Una respuesta de tipo {@link ValidateTokenResponse} con los
     ...
     *
     * @param validateAuthorization Objeto que extiende de
     * {@code ValidateAuthorization} y contiene los datos necesarios para
     * validar la autorización.
     * @param <T> Tipo que extiende de {@code ValidateAuthorization}.
     * @return Una respuesta de tipo {@link ValidateAuthorizationResponse} con
